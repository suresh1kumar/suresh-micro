...
function editElement(element,aliases){
	alert("ssssssssssssssssssss"+element.query);
	//alert("lllll"+element.length)
	...
	html=html+"	<div  class=\"holderdiv\">";
	html=html+"		<div class=\"titlediv\">";
	html=html+"			Officer Type";
	html=html+"		</div>";
	html=html+"		<div class=\"inputdiv\">";
	html=html+"			<select data-ng-value=\""+element.chartType+"\" data-ng-model=\"element.chartType\">";
	html=html+"				<option value=\"zone\">zone</option>";
	html=html+"				<option value=\"circle\">circle</option>";
	html=html+"				<option value=\"ssa\">ssa</option>";
	html=html+"			</select>";
	html=html+"		</div>";
	html=html+"	</div>";

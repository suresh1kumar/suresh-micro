			...
			['$scope','$window','$http',
				...
				$scope.isDisplay = true;
				    ...
				    $scope.sendOTP = function () {
				        ...
				        $http({
				          url: "/Login_Logout_Change_OTP/ForgetPassword",
				          method: "GET",
				          params:{
								"sendOtp":username
							}
				        	 ...
				        	 if(username!=null){
				        		 ...
				        		 $scope.isDisplay = false;
					        	 $window.location.href = '/Login_Logout_Change_OTP/forgetpassword.jsp';
					 			$scope.loading = false;
				        	 }
				         },function (error){
				 			console.log(error);
...
<section>
	<div class="container-fluid">
  			<div class="login-box">
          		<div>
          			<center><h3 class="title" style="color:#171c66;">Forget Password</h3></center>
          		</div><br>
          		...
          		<form name="log" novalidate="novalidate" >
					...
					<center>
			          <div class="col-lg-12">
			               <p>We sent to a sms with Password information</p>
			          </div>
	             </center>
          		<center>
          			<div class="row">

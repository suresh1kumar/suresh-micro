		 ...
		 <input type="hidden" ng-model="ctrl.user.userId" />
			<div class="w3-container w3-row-padding">
				<div class="w3-container w3-third">
					<label class = "w3-label w3-text-blue">Booking Date</label>
				...
				<div class="w3-container w3-third">
					<label class = "w3-label w3-text-blue">Description</label>
			...
			<div class="w3-container w3-row-padding">
				<div class="w3-container w3-third">
					<label class = "w3-label w3-text-blue">Source Station</label>
